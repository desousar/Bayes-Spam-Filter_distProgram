...
public class HamTest {
    ...
    public Set<String> testMailToSet(String s) throws IOException {
        ...
        String line;
        try {
            BufferedReader in = new BufferedReader(new FileReader("Programmieraufgabe1/ham-test/" + s));
        ...
        BufferedWriter visualisation = new BufferedWriter(new FileWriter("ham-test.txt"));
